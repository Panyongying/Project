...
<!-- admin-content part end -->
    ...
    <div class="listbiaoti am-cf">
      <ul class="am-icon-users"> 权限组管理</ul>
      
      <dl class="am-icon-home" style="float: right;">当前位置： 首页 > <a href="#">管理组列表</a></dl>
      
      <dl>
        <a href="/Project/project/index.php/HMadmin/AuthGroup/showAddAuthGroupPage" class="am-btn am-btn-danger am-round am-btn-xs am-icon-plus" > 手动添加管理组</a>
      </dl>
      <!--这里打开的是新页面-->
    ...
    <form action="/Project/project/index.php/HMadmin/AuthGroup/deleteAuthGroup" method="post" class="am-form am-g">
          <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
            ...
            <?php if(is_array($authGroupList)): foreach($authGroupList as $key=>$vo): ?><tr>
