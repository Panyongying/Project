    ...
    <div class="fbneirong">
      <form method="post" class="am-form">
        ...
        <div class="am-form-group am-cf">
          ...
          <div class="you">
            <?php if(is_array($auths)): foreach($auths as $key=>$v): ?><label style="margin-top:7px;width:140px"><input  type="checkbox" name="rules[]" value="<?php echo ($v["id"]); ?>"><?php echo ($v["title"]); ?></label><?php endforeach; endif; ?>
          </div>
        </div>
