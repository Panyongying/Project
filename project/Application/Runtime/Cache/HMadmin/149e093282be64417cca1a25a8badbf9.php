...
<div class="admin-biaogelist">
    ...
    <div class="fbneirong">
      <form class="Forms am-form" action="/Project/project/index.php/HMadmin/Goods/goodsEdit" method="post">
        <div class="am-form-group am-cf">
          <div class="zuo">商品名：</div>
          <div class="you">
            <input type="text" class="am-input-sm" id="doc-ipt-email-1" placeholder="请输入名称" name="name" value="<?php echo ($goodData["name"]); ?>">
          </div>
        </div>
        <div class="am-form-group am-cf">
          <div class="zuo">价格：</div>
          <div class="you">
            <input type="text" class="am-input-sm" id="doc-ipt-email-1" placeholder="请输入价格" name="price" value="<?php echo ($goodData["price"]); ?>">
          </div>
        </div>
        ...
        <div class="am-form-group am-cf">
          ...
          <div class="you">
            <textarea class="" rows="2" id="doc-ta-1" name="des"><?php echo ($goodData["des"]); ?></textarea>
          </div>
        </div>
        ...
        <div class="am-form-group am-cf">
          ...
          <div class="you">
            <textarea class="" rows="2" id="doc-ta-1" name="detail"><?php echo ($goodData["detail"]); ?></textarea>
          </div>
        </div>
        ...
        <div class="am-form-group am-cf">
          ...
          <div class="you">
            <select name="tid">
              ...
              <?php if(is_array($type)): foreach($type as $key=>$vi): ?><option class="tidop" value="<?php echo ($vi["id"]); ?>"><?php echo ($vi["name"]); ?></option><?php endforeach; endif; ?>
            </select>
          </div>
        </div>
        ...
        <div class="am-form-group am-cf">
          ...
          <div class="you" style="height: 145px;">
            <?php if(is_array($goodData['pic'])): foreach($goodData['pic'] as $key=>$vp): ?><img src="/Project/project/Public/<?php echo ($vp["pic"]); ?>" alt="" width="100">&nbsp;<a href="javascript:;" style="position:relative;top:80px;left:-55px;" class="editdel">x</a>
              <!-- <input type="hidden" name="pic[]" value="./<?php echo ($vp["pic"]); ?>"> --><?php endforeach; endif; ?>

          </div>
        </div>
        <script type="text/javascript">
        //ajax删除图片
          var url = "/Project/project/index.php/HMadmin/Goods/editDelPic";
        ...
        <script>
          ...
          var typeName = [<?php echo ($goodData['tid']); ?>];
          ...
          var status = [<?php echo ($goodData['status']); ?>];
