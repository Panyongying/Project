          ...
          <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped am-table-hover">
            ...
            <tbody>
              <?php if(is_array($list)): foreach($list as $key=>$ov): ?><tr>
                  ...
                  <td><a href="#"><?php echo ($ov["uid"]); ?></a></td>
                  <td class="am-hide-sm-only"><?php echo ($ov["orderstatus"]); ?></td><td class="am-hide-sm-only"><?php echo ($ov["ordersendstatus"]); ?></td>
                  <td class="am-hide-sm-only"><?php echo ($ov["orderaddtime"]); ?></td>
                  <td>
                      ...
                      <div class="am-btn-group am-btn-group-xs">
                        <button class="am-btn am-btn-default am-btn-xs am-text-success am-round de-btn"  oid="<?php echo ($ov["id"]); ?>" title="查看订单详情"><span class="am-icon-search"></span></button>
                        ...
                        <button class="am-btn am-btn-default am-btn-xs am-text-danger am-round rm-btn" oid="<?php echo ($ov["id"]); ?>" title="删除订单"><span class="am-icon-trash-o" ></span></button>
                      </div>
                    </div>
...
<script>
  $('.de-btn').click(function () {
    ...
    location.href = '/Project/project/index.php/HMadmin/OrderDetail/getOrderDetail/oid/' + oid;
  ...
  $('.rm-btn').click(function () {
    ...
    if (bool) {
      ...
      $.get(
        ...
        '/Project/project/index.php/HMadmin/Order/deleteOrder',
        {id:id},
        function (data) {
          if (data == 1) {
  ...
  $('#deleteSelect').click(function () {
    ...
    if (bool) {
      ...
      $.post(
        '/Project/project/index.php/HMadmin/Order/multipleDelete',
        {ids:ids},
        function (data) {
          if (data == 1) {
