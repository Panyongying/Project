...
<script>
  $('.de-btn').click(function () {
    ...
    location.href = '/2nd Project/04.10/project/index.php/HMadmin/OrderDetail/getOrderDetail/oid/' + oid;
  ...
  $('.rm-btn').click(function () {
    ...
    if (bool) {
      ...
      $.get(
        ...
        '/2nd Project/04.10/project/index.php/HMadmin/Order/deleteOrder',
        {id:id},
        function (data) {
          if (data == 1) {
  ...
  $('#deleteSelect').click(function () {
    ...
    if (bool) {
      ...
      $.post(
        '/2nd Project/04.10/project/index.php/HMadmin/Order/multipleDelete',
        {ids:ids},
        function (data) {
          if (data == 1) {
