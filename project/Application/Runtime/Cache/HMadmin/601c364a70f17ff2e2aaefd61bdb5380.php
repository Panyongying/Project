  ...
  <ul>
    ...
    <form class="am-form am-g">
          <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
            ...
            <?php if(is_array($goodsList)): foreach($goodsList as $k=>$vo): ?><tr>
                ...
                <td><div class="am-btn-toolbar" data-num="<?php echo ($k); ?>">
                    <div class="am-btn-group am-btn-group-xs">
                      ...
                      <button class="am-btn am-btn-default am-btn-xs am-text-danger am-round" data-id="<?php echo ($vo["id"]); ?>"><span class="am-icon-trash-o"></span></button>
                    </div>
                  </div></td>
            ...
            for (var i=0; i<$('.am-btn-toolbar').length-1; i++) {

              var btns = $('div[data-num='+i+']').find('button').eq(2);
