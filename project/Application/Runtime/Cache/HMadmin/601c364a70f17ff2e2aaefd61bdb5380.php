            ...
            <?php if(is_array($goodsList)): foreach($goodsList as $key=>$vo): ?><tr>
                ...
                <td><div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                      ...
                      <button class="am-btn am-btn-default am-btn-xs am-text-danger am-round"><a href="/Project/project/index.php/HMadmin/Goods/deletes/id/<?php echo ($vo["id"]); ?>"><span class="am-icon-trash-o">1</span></a></button>
                    </div>
                  </div></td>
