...
<link rel="icon" type="image/png" href="/www/pro/Project/project/Public/Backstage/i/favicon.png">
<link rel="apple-touch-icon-precomposed" href="/www/pro/Project/project/Public/Backstage/i/app-icon72x72@2x.png">
<meta name="apple-mobile-web-app-title" content="Amaze UI" />
<link rel="stylesheet" href="/www/pro/Project/project/Public/Backstage/css/amazeui.min.css"/>
<link rel="stylesheet" href="/www/pro/Project/project/Public/Backstage/css/admin.css">
<script src="/www/pro/Project/project/Public/Backstage/js/jquery.min.js"></script>
<script src="/www/pro/Project/project/Public/Backstage/js/app.js"></script>
</head>
<body>
...
<header class="am-topbar admin-header">
    <div class="am-topbar-brand"><img src="/www/pro/Project/project/Public/Backstage/i/logo.png"></div>
   ...
   <li class="kuanjie">
   	...
   	<a href="#">奖金管理</a>
   	<a href="#">订单管理</a>
   	<a href="/www/pro/Project/project/index.php/HMadmin/Goods/index">商品管理</a>
   	<a href="#">个人中心</a>
   	<a href="#">系统设置</a>
   </li>
...
<div class="nav-navicon admin-main admin-sidebar">
    ...
    <div class="sideMenu">
      <h3 class="am-icon-flag"><em></em> <a href="/www/pro/Project/project/index.php/HMadmin/Goods/index">商品管理</a></h3>
      <ul>
        <li><a href="/www/pro/Project/project/index.php/HMadmin/Goods/index">商品列表</a></li>
  ...
  <ul>
    ...
    <form class="am-form am-g" action="">
          <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
            ...
            <?php if(is_array($goodsList)): foreach($goodsList as $key=>$vo): ?><tr>
                ...
                <td><div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                      ...
                      <button class="am-btn am-btn-default am-btn-xs am-text-danger am-round"><a href="/www/pro/Project/project/index.php/HMadmin/Goods/deletes/id/<?php echo ($vo["id"]); ?>"><span class="am-icon-trash-o">1</span></a></button>
                    </div>
                  </div></td>
...
<script src="/www/pro/Project/project/Public/Backstage/js/polyfill/rem.min.js"></script>
<script src="/www/pro/Project/project/Public/Backstage/js/polyfill/respond.min.js"></script>
<script src="/www/pro/Project/project/Public/Backstage/js/amazeui.legacy.js"></script>
<![endif]-->

<!--[if (gte IE 9)|!(IE)]><!-->
<script src="/www/pro/Project/project/Public/Backstage/js/amazeui.min.js"></script>
<!--<![endif]-->
