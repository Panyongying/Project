...
<!-- admin-content part end -->
 ...
 <div class="admin-biaogelist">
      <div class="listbiaoti am-cf">
        ...
        <dl>
          <a href="/Project/project/index.php/HMadmin/CustomService/showAddType" type="button" class="am-btn am-btn-danger am-round am-btn-xs am-icon-plus" data-am-modal="{target: '#my-popup'}">添加商品一级分类</a>
        </dl>
          ...
          <tbody>
            ...
            <?php if(is_array($typeList)): foreach($typeList as $key=>$v): ?><tr>
                  ...
                  <td><div class="am-btn-toolbar">
                      ...
                      <a href="/Project/project/index.php/HMadmin/CustomService/showAddType/id/<?php echo ($v["id"]); ?>/path/<?php echo ($v["path"]); ?>" class="am-btn am-btn-default am-btn-xs am-text-success am-round am-icon-file" data-am-modal="{target: '#my-popups'}" title="添加子栏目"></a>
                        ...
                        <a href="/Project/project/index.php/HMadmin/CustomService/deleteTypeOne/id/<?php echo ($v[id]); ?>" class="deleteBtn am-btn am-btn-default am-btn-xs am-text-danger am-round"  title="删除"><span class="am-icon-trash-o"></span></a>
                      </div>
                    </div></td>
          ...
          <script>
            ...
            $('.modifyBtn').on('click', function(){
              ...
              var id = $(this).attr('data-id');
                $.ajax({
                  url:'/Project/project/index.php/HMadmin/CustomService/modifyTypeName/id/' + id + '/name/' + name,
