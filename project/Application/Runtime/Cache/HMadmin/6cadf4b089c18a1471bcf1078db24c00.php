          ...
          <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped am-table-hover">
            ...
            <tbody>
              <?php if(is_array($list)): foreach($list as $key=>$ov): ?><tr>
                  ...
                  <td><?php echo ($ov["smalltitle"]); ?></td>
                  <td><?php echo ($ov["bigtitle"]); ?></td>
                  <td><img src="/Project/project/Public<?php echo ($ov["pic"]); ?>" alt="" height="50"></td>
                  ...
                  <td>
                      ...
                      <div class="am-btn-group am-btn-group-xs">
                        <button class="am-btn am-btn-default am-btn-xs am-text-secondary am-round mo-btn" data-am-modal="{target: '#my-popups'}" pid=<?php echo ($ov["id"]); ?> title="修改大图"><span class="am-icon-pencil-square-o"></span></button>
                        <button class="am-btn am-btn-default am-btn-xs am-text-danger am-round rm-btn" pid="<?php echo ($ov["id"]); ?>" title="删除大图"><span class="am-icon-trash-o" ></span></button>
                      </div>
                    </div>
...
<script>
  $('.mo-btn').click(function () {
    ...
    location.href = "/Project/project/index.php/HMadmin/IndexPic/editIndexPic/id/" + pid;
  ...
  $('.rm-btn').click(function () {
    ...
    if (bool) {
      $.get(
        '/Project/project/index.php/HMadmin/IndexPic/deleteIndexPic',
        {id:id},
        function (data) {
          if (data == 1) {
  ...
  $('#deleteSelect').click(function () {
    ...
    if (bool) {
      ...
      $.post(
        '/Project/project/index.php/HMadmin/IndexPic/multipleDelete',
        {ids:ids},
        function (data) {
          if (data == 1) {
