            ...
            <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                ...
                <td>
                    ...
                    <div class="am-btn-group am-btn-group-xs">
                      <button class="am-btn am-btn-default am-btn-xs am-text-success am-round"><span class="am-icon-search" title="查看会员详情"></span> </button>
                      <button class="am-btn am-btn-default am-btn-xs am-text-secondary am-round" data-am-modal="{target: '#my-popups'}" title="修改会员"><span class="am-icon-pencil-square-o"></span></button>
                       <span class="del" data-value="<?php echo ($vo["id"]); ?>"><button  class="am-btn am-btn-default am-btn-xs am-text-danger am-round" title="删除会员"><span class="am-icon-trash-o" ></span></button></span>
                    </div>
                  </div>
