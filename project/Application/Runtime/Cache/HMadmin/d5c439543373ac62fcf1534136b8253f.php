...
<div class="admin-biaogelist">
    ...
    <div class="listbiaoti am-cf">
      <ul class="am-icon-flag on"> 编辑权限</ul>
      
      <dl class="am-icon-home" style="float: right;"> 当前位置： 首页 > <a href="#">编辑权限</a></dl>
    ...
    <div class="fbneirong">
      ...
      <input type="hidden" name="id" value="<?php echo ($authRule["id"]); ?>">
        <div class="am-form-group am-cf">
          ...
          <div class="you">
            <input type="text" class="am-input-sm" id="doc-ipt-email-1" name="name" value="<?php echo ($authRule["name"]); ?>" placeholder="请输入权限路径">
          </div>
        </div>
        <div class="am-form-group am-cf">
          <div class="zuo">权限功能名：</div>
          <div class="you">
            <input type="text" class="am-input-sm" id="doc-ipt-pwd-1" name="title" value="<?php echo ($authRule["title"]); ?>" placeholder="请输入功能名">
          </div>
        </div>
        ...
        <div class="am-form-group am-cf">
          <div class="zuo">规则：</div>
          <div class="you">
            <input type="text" class="am-input-sm" id="doc-ipt-pwd-1" name="situation" value="<?php echo ($authRule["situation"]); ?>" placeholder="不填默认为空">
          </div>
        </div>
