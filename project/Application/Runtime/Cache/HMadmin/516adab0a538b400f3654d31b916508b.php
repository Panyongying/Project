...
<div class="admin-biaogelist">
    ...
    <div class="listbiaoti am-cf">
      ...
      <dl>
        <a href="/Project/project/index.php/HMadmin/Goods/addstock/gid/<?php echo ($gid); ?>"><button type="button" class="am-btn am-btn-danger am-round am-btn-xs am-icon-plus"> 添加库存/颜色/尺码</button></a>
      </dl>
    ...
    <div class="fbneirong">
      ...
      <th>颜色/尺码</th>
      <th>操作</th>
      <?php if(is_array($stockDetail)): foreach($stockDetail as $key=>$vo): ?><tr>
          <td>
            <?php echo ($vo["id"]); ?>
          </td>
          <td>
          ...
          <td>
            <?php if(is_array($vo['aid'])): foreach($vo['aid'] as $key=>$v): echo ($v); ?>,<?php endforeach; endif; ?>
          </td>
          <td><a href="/Project/project/index.php/HMadmin/Goods/stockEdit/id/<?php echo ($vo["id"]); ?>">修改</a>
              <a href="javascript:;" data-id="<?php echo ($vo["id"]); ?>" class="stockDel">删除</a></td>
        </tr><?php endforeach; endif; ?>
      </table>
      <div class="am-form-group am-cf">
        <div class="you">
            <a href="/Project/project/index.php/HMadmin/Goods/Index" class="am-btn am-btn-success am-radius">返回</a>
        </div>
      </div>
    </div>
  ...
  <script>
    ...
    $('.stockDel').on('click', function() {

      var url = "/Project/project/index.php/HMadmin/Goods/stockDel";
