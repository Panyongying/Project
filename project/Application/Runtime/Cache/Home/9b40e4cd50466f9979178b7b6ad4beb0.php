  ...
  <tr>
    <td align="center" class="table_td_padding_20px"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tbody><tr>
        ...
        <td width="152" align="right"><input name="button" type="submit" style="border: 0px; background: rgb(0, 0, 0);" class="input_132px" id="button_enter" disabled="true" value="发送" ></td>
      </tr>
      <script>
            ...
            ws.onmessage = function (e) {
              ...
              if (data.cid == cid) {
                ...
                $('.div_talklist').append('客服:'+ data.content + "<br/>");
              }
