        ...
        <header class="header-global"><!-- Header -->
            ...
            <!--AEMPUBPRDAP10-->
                    ...
                    <div class="wrapper" ng-init="hmClubEnabled=false; offersSpace=&#39;&#39;; hmClubServiceCacheDuration=0; hmRedirectPath=&#39;&#39;">
                        <a  href="" title="HM.com" class="logotype" style='background-image: url("/Project/project/Public/show/sprites.png");'>
                        </a>
                                ...
                                <div class="inner">
                                  <div class="signin-rollover-login" id="showlogin">
                                      <form class="responsive form-section ng-pristine ng-valid" action="https://www2.hm.com/zh_cn/j_spring_security_check" onsubmit="trackSubmitLogin()" method="POST">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input name="j_username" type="email" placeholder="" id="txt-signin-rollover-email">
                                            </div>
                                            <div class="input-group">
                                                <label for="txt-signin-rollover-password">密码:</label>
                                                <input name="j_password" type="password" id="txt-signin-rollover-password">
                                            </div>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <p>
                                                    <a href="javascript:;" class="underline">忘了密码？</a>
                                                </p>
                                            </div>
                                  ...
                                  <div class="signin-rollover-join" id="showadd">
                                    	<section class="responsive create-account popdown-form">
                    	                    ...
                    	                    <form action="/Project/project/index.php/Home/User/register" method="POST" class="responsive form-section ng-pristine ng-valid">
